                ...
                <div class="content-box wow bounceInDown modal-content">
                    <h3 class="content-box-header content-box-header-alt bg-default">
                        ...
                        <span class="header-wrapper">
                            <font face="Microsoft Sans Serif">Welcome Client</font>
                    ...
                    <div class="content-box-wrapper">
                        ...
                        <input type="submit" class="btn btn-success btn-block" name="loginclient" value="Log in"> 
                    </div>
                    <div class="content-box-wrapper">
                        <a style="color:#FF0000; padding-right: 65px;"; href="new_client1.php">Not yet register?</a>
						<a style="color:#FF0000"; href="login.php">Back to Admin Login</a>
                    </div>
                </div>
            </form>
        </div> 
